...
*** 提案 [0/2]
   ...
   - [ ] 各自の ~/progs/lects/の下，02.orgとかに講義のメモを作成しませ
     んか？ 
...
** Doing 既習の内容を思いだす
   ...
   [[http://wiki.cis.iwate-u.ac.jp/~suzuki/lects/prog/org-docs/cis-programming-lects/][プログラム関連演習@cis]] (([[file+emacs:~suzuki/lects/prog/site/org-docs/cis-programming-lects/][cis-org]] [[file+emacs:~/COMM/Lects/prog/site/org-docs/cis-programming-lects][s-org]])) 
...
** Todo テストと関数と開発について理解する
 
   [[http://wiki.cis.iwate-u.ac.jp/~suzuki/lects/prog/org-docs/what-is-tdd/][
   テストによる開発とは]]
   (([[file+emacs:~suzuki/lects/prog/site/org-docs/what-is-tdd/][@cis.org]]
   [[file+emacs:~/COMM/Lects/prog/site/org-docs/what-is-tdd/][@s.org]]))
   を説明します：

   - できるだけやりながら説明します([[emacs org-mode+babel][補足]])。
   - 機能とは何か理解しましょう。
   - テストとは何か理解しましょう。
   - 機能を要求・利用・実装・テスト・提供することを理解しましょう。
   - 概念的なことが多いですが，実際のプログラムの開発をおこないながら，
     身をもって，理解していきましょう。
   - 必要なら，次週以降もまた説明します。

** Todo テスト体験

  [[http://wiki.cis.iwate-u.ac.jp/~suzuki/lects/prog/org-docs/cutter][cutterの使い方]] (([[file+emacs:~suzuki/lects/prog/site/org-docs/cutter][@cis.org]] [[file+emacs:~/COMM/Lects/prog/site/org-docs/cutter][@s.org]]))
