* 前回の講義
  ...
  [[http://wiki.cis.iwate-u.ac.jp/~suzuki/lects/prog/lects/03][3回目]] ([[~suzuki/lects/prog/site/lects/03/][cis.org]] [[~/COMM/Lects/prog/site/lects/03/][s.org]]) の進行状況確認とレスポンスカードのまとめ
...
* Todo カード表示問題 simple のテストによる開発
   ...
   - テストによる開発を始めます。<2015-11-10 火>
   - 機能 card_new のテストができるぐらいまで，進みたいです。
     機能の利用，テスト，要求，実装，提供を意識してください。
