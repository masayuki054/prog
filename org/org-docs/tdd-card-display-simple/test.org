# * カードのソート
#+include: Makefile.org :noweb yes
#+include: card.h.org :noweb yes
#+include: test_card.c.org :noweb yes
#+include: test_sort.c.org :noweb yes
#+include: card.c.org :noweb yes
#+include: cards.c.org :noweb yes
